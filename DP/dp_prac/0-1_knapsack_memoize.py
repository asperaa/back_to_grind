...
def knapsack_helper(n, curr_weight, weight, value, capacity, dp):
    ...
    if curr_weight + weight[n] > capacity:
        dp[n][curr_weight] = knapsack_helper(n, curr_weight, weight, value, capacity, dp)
    if curr_weight + weight[n] < capacity:
        chosen = value[n] + knapsack_helper(n, curr_weight + weight[n], weight, value, capacity, dp)
        not_chosen = knapsack_helper(n, curr_weight,weight, value, capacity, dp)
